...
%
% plot_aggtree - Generates a graphical summary of an aggregation procedure.
%
% Usage:
%      plot_aggtree(spikes)
%
...
for root = 1:length(treeroots)
	...
	text(x1 - 0.61, y2*1.08,    ['Clust #' num2str(oldname)], 'Color', [0 0.5 0.5], 'FontSize', 8);
    text(x1 - 0.59, y2*1.04,    ['N=' num2str(clustsize)], 'Color', [1 0 0], 'FontSize', 8);
end
% 
% Prettify the axes
hold off;
...
xlabel('Cluster ID'); ylabel('Aggregation step');   